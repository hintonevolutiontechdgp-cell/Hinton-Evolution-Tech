    ...
    <AnimatePresence>
      ...
      >
        ...
        >
          <button
            onClick={onClose}
            className="absolute top-4 right-4 sm:top-5 sm:right-5 w-11 h-11 sm:w-12 sm:h-12 flex items-center justify-center text-slate-600 hover:text-slate-950 bg-slate-100 hover:bg-slate-200 active:bg-slate-300 border border-slate-200/80 rounded-2xl transition-all duration-150 cursor-pointer shadow-xs focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 active:scale-95 z-20"
            aria-label="Close dialog (Press Escape to close)"
            title="Close (Esc)"
          >
            <X className="w-6 h-6 sm:w-6.5 sm:h-6.5" strokeWidth={2.25} />
          </button>

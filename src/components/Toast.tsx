      ...
      {message && (
        ...
        >
          <div className="flex items-center gap-3 p-4 rounded-2xl bg-slate-900 text-white border border-slate-800 shadow-2xl backdrop-blur-md">
            ...
            <button
              onClick={onClose}
              className="w-8 h-8 flex items-center justify-center text-slate-400 hover:text-white transition-all cursor-pointer rounded-xl hover:bg-slate-800 active:bg-slate-700 active:scale-95 shrink-0"

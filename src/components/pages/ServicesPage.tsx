...
import { IntegratedSolutionsSection } from '../IntegratedSolutionsSection';
import { SEO } from '../SEO';
...
export function ServicesPage({ onNavigate, onOpenConsultation }: ServicesPageProps) {
  ...
  return (
    <div className="space-y-16 py-8 sm:py-12">
      ...
      {/* Integrated Solutions, Methodology & Ecosystem Architecture */}
      {!searchQuery && (
        <IntegratedSolutionsSection onOpenConsultation={onOpenConsultation} />
      )}

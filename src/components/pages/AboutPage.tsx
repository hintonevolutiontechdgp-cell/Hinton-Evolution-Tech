...
export function AboutPage({ onOpenConsultation }: AboutPageProps) {
  return (
    <>
      <SEO 
        title="About Us | Hinton Evolution Tech Durgapur"
        description="Learn about Hinton Evolution Tech, a leading software engineering and digital growth agency in Durgapur dedicated to high-performance web development."
      />

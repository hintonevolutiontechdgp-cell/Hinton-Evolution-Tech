...
export default function App() {
  const getInitialRoute = (): { page: PageId, serviceId?: string } => {
    ...
    if (path === 'landing-page-design' || path === 'landing-page') return { page: 'service-detail', serviceId: 'landing-page-design' };
    ...
    if (path === 'sitemap' || path === 'sitemap.html' || path === 'site-map') return { page: 'sitemap' };
    
    const validPages: PageId[] = [
      'home', 'services', 'about', 'solutions', 'portfolio', 'pricing', 
      'process', 'contact', 'privacy', 'refund', 'cancellation', 
      'duration', 'late', 'terms', 'faq', 'sitemap'
    ];

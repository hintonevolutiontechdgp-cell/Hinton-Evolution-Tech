...
export const ALL_SERVICES: ServiceItem[] = [
  ...
  // 02 / Web
  {
    ...
    shortDesc: 'We design focused, high-converting landing pages for marketing campaigns, products, services, events and lead-generation initiatives.',
  ...
  },
  {
    ...
    shortDesc: 'We redesign outdated or underperforming websites to create a modern, responsive and user-friendly digital experience.',
